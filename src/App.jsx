  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-app-blue-bg bg-cover bg-center px-4">
      <div className="bg-white bg-opacity-30 backdrop-blur-lg shadow-lg rounded-xl p-8 w-full max-w-3xl flex flex-col items-center">
        <h2 className="text-2xl md:text-6xl font-extrabold mb-8 text-center">Character Counter </h2>
        <input
          type="text"
          value={inputVal}
        ...
        />
        <h3 className="mt-4 text-lg text-center md:text-xl font-semibold text-black">Text Length:</h3>
        <p className="text-blue-600 w-auto text-2xl sm:text-2xl md:text-3xl font-bold italic bg-white bg-opacity-75 px-4 py-2 m-2 rounded-lg shadow-md transition-all duration-300">
          {inputVal.length}
        </p>
